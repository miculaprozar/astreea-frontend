...
import { ADB2C_TENANT, ADB2C_POLICY, ADB2C_CLIENT, ADB2C_REDIRECT_URI, ADB2C_POLICY_EDIT_PROFILE } from "./api/utils/consts.js";
import {
  JsonHubProtocol,
  HubConnectionState,
...
export default function App() {
  ...
  const getCodeAuth = async () => {
    ...
    //let logoutResponse = await WebBrowser.openAuthSessionAsync(`https://${ADB2C_TENANT}.b2clogin.com/${ADB2C_TENANT}.onmicrosoft.com/${ADB2C_POLICY}/oauth2/v2.0/logout?post_logout_redirect_uri=${ADB2C_REDIRECT_URI}`, ADB2C_REDIRECT_URI); // logout
